...
const TIMELINE = [
  ...
  { year: "2018", title: "Infrastructure Expansion", desc: "Expanded to a massive new facility with advanced climate-controlled inspection labs and dedicated material handling for components up to 10 meters." },
